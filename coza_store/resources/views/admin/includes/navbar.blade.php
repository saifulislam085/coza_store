    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="./examples/icons.html">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="./examples/maps.html">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle"data-toggle="dropdown"  href="./examples/profile.html">
                        <i class="ni ni-single-02 text-yellow"></i> Product
                        <div class="dropdown-menu">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('manage-order')}}">
                        <i class="ni ni-bullet-list-67 text-red"></i> Manage Order
                    </a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle"data-toggle="dropdown"  href="./examples/profile.html">
                        <i class="ni ni-key-25 text-info"></i> Slider
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="{{route('add-slider')}}">Add Slider</a>
                            <a class="dropdown-item" href="{{route('manage-product')}}">Manage Slider</a>
                        </div>
                    </a>
                </li>

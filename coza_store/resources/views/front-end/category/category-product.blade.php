                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="{{asset($categoryProduct->product_image)}}" alt="IMG-PRODUCT">

                            <a href="{{route('product-details',['id'=>$categoryProduct->id])}}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
                                Quick View
                            </a>
                        </div>
                        ...
                        <div class="block2-txt flex-w flex-t p-t-14">
                            <div class="block2-txt-child1 flex-col-l ">
                                ...
                                <span class="stext-105 cl3">
									Tk. {{$categoryProduct->product_price}}
								</span>
                            </div>
